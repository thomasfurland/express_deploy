defmodule Mix.Tasks.Exp.New do
  @moduledoc """
  Creates a new Phoenix project.

  It expects the path of the project as an argument.

      $ mix exp.new PATH [--module MODULE] [--app APP]
  ...
  `mix exp.new` by default prompts you to fetch and install your
  dependencies. You can enable this behaviour by passing the
  `--install` flag or disable it with the `--no-install` flag.

  ## Examples

      $ mix exp.new hello_world

  Is equivalent to:

      $ mix exp.new hello_world --module HelloWorld
  """

  use Mix.Task
  alias Phx.New.{Generator, Project, Single}
